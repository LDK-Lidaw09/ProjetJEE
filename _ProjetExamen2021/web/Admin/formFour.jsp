        ...
        <div class="col-md-7 col-lg-6 ml-auto">
                ...
                <div class="row">
                    ...
                    <div class="input-group col-lg-12 mb-4">
                        ...
                        <input id="nationalite" type="text" name="nat" placeholder="Votre Nationalité" class="form-control bg-white border-left-0 border-md" required>
                    </div>
                    ...
                    <div class="form-group col-lg-12 mx-auto mb-0">
                        <button type="submit" class="btn btn-primary btn-block py-2">Créer un fournisseur </button>
