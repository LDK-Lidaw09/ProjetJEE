 ...
 * @author ADMIN
 */
public class ListeFour extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListeFour</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListeFour at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
   ...
   FournisseurDao dao = new FournisseurDao();
    ...
    out.print("<tr>"
        ...
        out.print("<tr><td>"+e.getCodeFour()+"</td><td>"+e.getNomFour()+"</td><td>"+e.getAdresseFour()+"</td><td>"+e.getNationaliteFour()+"</td><td>"+e.getLogin()+"</td><td>"+e.getPassword()+"</td><td>"+e.getProfil()+"</td>"
                + "<td><a class=\"btn btn-danger mt-3\" href='DeleteFour1?id="+e.getCodeFour()+"'>delete</a></td>"
                    + "</tr>");
        }
        out.print("</table>");
        out.println("<a class=\"btn btn-success mt-3\"  href='Admin/formFour.jsp'>Add New Four</a>");
        out.close();
    }
