 ...
 * @author ADMIN
 */
public class ListeProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListeProduct</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListeProduct at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    out.print("<tr>"
        ...
        + "</tr>");
        for(Produit e:list){
        out.print("<tr><td>"+e.getNomProd()+"</td><td>"+e.getCategorieProd()+"</td><td>"+e.getPrixUnitaire()+"</td><td>"+e.getDateFab()+"</td><td>"+e.getDateExp()+"</td>"
            + "<td><a class=\"btn btn-success mt-3\" href='CommandeServlet?id="+e.getCodeProd()+"'>Ajouter</a></td>"
                    + "</tr>");
        }
        out.print("</table>");
        out.println("<a class=\"btn btn-success mt-3\"  href='Client/login.jsp'>Deconnexion</a>");
        out.close();
    }
