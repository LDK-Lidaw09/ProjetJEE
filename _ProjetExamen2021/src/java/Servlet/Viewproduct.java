...
public class Viewproduct extends HttpServlet {
    ...
    out.print("<tr>"
        ...
        + "</tr>");
        for(Produit e:list){
        out.print("<tr><td>"+e.getCodeProd()+"</td><td>"+e.getNomProd()+"</td><td>"+e.getCategorieProd()+"</td><td>"+e.getQteProd()+"</td><td>"+e.getPrixUnitaire()+"</td><td>"+e.getDateFab()+"</td><td>"+e.getDateExp()+"</td>"
            + "<td><a class=\"btn btn-success mt-3\" href='EditProduct?id="+e.getCodeProd()+"'>edit</a></td>"
                + "<td><a class=\"btn btn-danger mt-3\" href='DeleteProduct?id="+e.getCodeProd()+"'>delete</a></td>"
                    + "</tr>");
        }
        out.print("</table>");
        out.println("<a class=\"btn btn-success mt-3\"  href='Fournisseur/formproduit.jsp'>Add New Product</a>");
