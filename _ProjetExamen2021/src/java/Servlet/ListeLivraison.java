...
import livraison.DAOException;
import livraison.livraisondao;
...
public class ListeLivraison extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListeLivraison</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListeLivraison at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    out.print("<tr>"
        + "<th>Codede Livraison</th>"
        + "<th>Date De Livraison</th>"
        + "</tr>");
        for(Livraison e:list){
        out.print("<tr><td>"+e.getCodeLivraison()+"</td><td>"+e.getDateLivraison()+"</td>"
                    + "</tr>");
        }
        out.print("</table>");
