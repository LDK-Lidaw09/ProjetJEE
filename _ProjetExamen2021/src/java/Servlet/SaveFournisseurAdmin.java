 ...
 * @author ADMIN
 */
public class SaveFournisseurAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SaveFournisseurAdmin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SaveFournisseurAdmin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    if(status > 0){
            out.println("<script type=\"text/javascript\">");
                                 out.println("alert('Le fournisseur "+name+" a bien été ajouté');");
